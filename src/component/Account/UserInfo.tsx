...
type Props = {
  /** Dữ liệu người dùng do parent cung cấp (đã fetch ở ngoài) */
  user: User | null;
  /** Trạng thái loading do parent quản lý */
  isLoading?: boolean;

  /** Mở modal/flow sửa thông tin (parent tự quyết định mở modal nào) */
  onOpenEdit?: () => void;
